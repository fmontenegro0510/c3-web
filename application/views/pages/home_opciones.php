            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                        ...
                        <hr>
                        <div class="col-12">
                            <button class="btn btn-primary w-100 py-3" type="submit">Ver Más</button>
                        </div>                        
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                        ...
                        <hr>
                        <div class="col-12">
                            <button class="btn btn-primary w-100 py-3" type="submit" data-bs-toggle="modal" data-bs-target="#exampleModal">Ver Más</button>
                        </div>
                    </div>
                </div>
            </div>
