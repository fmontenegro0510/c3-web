    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
    	...
    	<div class="collapse navbar-collapse" id="navbarCollapse">
    		<div class="navbar-nav ms-auto p-4 p-lg-0">
    			<a href="<?php echo base_url(); ?>autoridades" class="nav-item nav-link active">
    				<h5 class="mb-0">Autoridades</h5>
    			</a>
    			<a href="<?php echo base_url(); ?>quienes_somos" class="nav-item nav-link">
    				<h5 class="mb-0">Quienes Somos</h5>
    			</a>
    			<div class="nav-item dropdown">
    				<a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
    					<h5 class="mb-0">Normativa</h5>
    				</a>
    				<div class="dropdown-menu border-0 m-0" id="dropdown_menu_prensa">
    					<a href="<?php echo base_url(); ?>prensa_blog" class="dropdown-item">
    						<h5 class="mb-0">Leyes/Reglamentación</h5>
    					</a>
    					<a href="<?php echo base_url(); ?>prensa_blog" class="dropdown-item">
    						<h5 class="mb-0">Constitución Provincial</h5>
    					</a>
    					<a href="<?php echo base_url(); ?>prensa_galeria" class="dropdown-item">
    						<h5 class="mb-0">Reglamentación Interna</h5>
    					</a>
    				</div>
    			</div>
				<div class="nav-item dropdown">
    				...
    				<div class="dropdown-menu border-0 m-0" id="dropdown_menu_prensa">
    					<a href="<?php echo base_url(); ?>prensa_blog" class="dropdown-item">
    						<h5 class="mb-0">Programas Históricos</h5>
    					</a>
    					<a href="<?php echo base_url(); ?>prensa_blog" class="dropdown-item">
    						<h5 class="mb-0">Juez STJ</h5>
    					</a>
    					<a href="<?php echo base_url(); ?>prensa_galeria" class="dropdown-item">
    			...
    			<a href="<?php echo base_url(); ?>propuestas" class="nav-item nav-link">
    				<h5 class="mb-0">Propuestas</h5>
    			</a>
    			<a href="<?php echo base_url(); ?>sentencias" class="nav-item nav-link">
    				<h5 class="mb-0">Sentencias</h5>
    			</a>
    			<div class="nav-item dropdown">
    				<a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
    					<h5 class="mb-0">Prensa</h5>
    				</a>
    				<div class="dropdown-menu border-0 m-0" id="dropdown_menu_prensa">
    					<a href="<?php echo base_url(); ?>prensa_blog" class="dropdown-item">
    						<h5 class="mb-0">Blog de Prensa </h5>
    					</a>
    					<a href="<?php echo base_url(); ?>prensa_galeria" class="dropdown-item">
    			...
    			<a href="<?php echo base_url(); ?>contacto" class="nav-item nav-link">
